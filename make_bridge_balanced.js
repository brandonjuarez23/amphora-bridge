...
// type/order/length cells with a fixed seed. Output train_bridge_bal.jsonl.
const fs=require("fs");
...
fs.writeFileSync("train_bridge_bal.jsonl", out.map(r=>JSON.stringify(r)).join("\n")+"\n");
console.log("wrote train_bridge_bal.jsonl:", out.length, "lines");
